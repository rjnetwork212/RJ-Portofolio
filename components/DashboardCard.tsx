...
const DashboardCard: React.FC<DashboardCardProps> = ({ title, value, change, icon }) => {
  ...
  return (
    <div className="bg-slate-900 p-6 rounded-2xl border border-slate-800 flex flex-col justify-between hover:border-cyan-500 transition-all duration-300 transform hover:-translate-y-1">
